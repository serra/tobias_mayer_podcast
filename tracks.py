...
part_titles = {"": "", "1": PEOPLE, "2": PROCESS,
               "3": CULTURE, "4": CITIZENSHIP, "5": APPENDICES}
...
class TrackView():
    ...
    def __init__(self, track):
        self.part = track[0]
        self.original_audio_file_url = f"{base_url}/{track[1]}"
        self.chapter_number = track[2]
        self.title = track[3]
...
tracks = [
    [0, "tps_av/prelude.m4a", "", "Prelude", 0, None],
    [0, "tps_av/intro2.m4a", "", "Introduction to Audio Edition", 4, None],
    [0, "tps_av/foreword.m4a", "", "Foreword by Ron Jeffries", 6, None],
